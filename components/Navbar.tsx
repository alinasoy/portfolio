import { logo4 } from '@/public/assets';
        ...
        justify-between'>
            ...
            <div className='hidden mdl:inline-flex items-center gap-7'>
                <ul className='flex text-[13px] gap-7'>
                    ...
                    className='flex items-centeer gap-1 font-medium text-textDark 
                ...
                <a href='/assets/Alina soy resume.pdf' target='_blank'>
                <motion.button
                    initial={{ y: -10, opacity: 0}}
                    animate={{ y: 0, opacity: 1}}
                    transition={{ duration: 0.1}}
            ...
            >
                ...
                <span className='w-full h-[2px] bg-textGreen inline-flex transform
                translate-x-3 group-hover:translate-x-2 transition-all ease-in-out duration-300'></span>
                <span className='w-full h-[2px] bg-textGreen inline-flex transform 
            ...
            {showMenu && (
                ...
                >
                    ...
                    <motion.a 
                        ...
                        target='_blank'
                    >
                    <span className='w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 
                    ...
                    hover:-translate-y-2 transition-all duration-300 gap-4'><TbBrandGithub /></span>
                    </motion.a>
                    <motion.a 
                        initial={{ y: 20, opacity: 0}}
                        animate={{ y:0, opacity:1}}
                        transition={{ delay: 0.8, ease: "easeIn"}}
                        href='https://www.linkedin.com/in/alina-soy/' 
                        target='_blank'>
                    <span className='w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 
                    hover:border-textGreen text-zinc-200 rounded-full inline-flex
                    items-center justify-center hover:text-textGreen cursor-pointer
                    ...
                    animate={{ y:0, opacity:1}}
                    transition={{ delay: 0.8, ease: "easeIn"}}
                    href='https://www.instagram.com/_alina_soy/' 
                    target='_blank'
                    >
                    <span className='w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 
                    hover:border-textGreen text-zinc-200 rounded-full inline-flex
                    ...
                    href='https://www.facebook.com/alina.soy.1/' 
                    target='_blank'
                    >
                    <span className='w-10 h-10 text-xl bg-bodyColor border-[1px] border-zinc-700 
                    hover:border-textGreen text-zinc-200 rounded-full inline-flex
                    ...
                    <motion.a
                        initial={{ opacity: 0}}
                        animate={{ opacity: 1}}
                        transition={{ dealy: 1.2, ease: "easeIn"}}
                        className="text-sm w-72 tracking-widest text-textGreen text-center mt-4"
                        href="mailto:alinasoy24@gmail.com"
                    >
                        <p>alina.com</p>
                    </motion.a>
                </motion.div>
